                ...
                <div class="panel-body">
                    <form role="form" action="#" method="post" id="login_form">
                        <fieldset>
                            ...
                            <div class="form-group">
                                <input class="form-control" placeholder="密码:123" name="password" type="password" value="">
                            </div>
                            <!-- Change this to a button or input when using this as a form -->
                            <a href="javascript:void(0)" class="btn btn-lg btn-info btn-block" id='login_btn'>登录</a>
                        </fieldset>
                    </form>
